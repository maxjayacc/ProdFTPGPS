   ...
   // this.name=name;
    ...
    JOptionPane.showMessageDialog(null, "Se enviará el archivo :\n"+name+"\n Protocolo:"+protocolo+"\n Puerto:"+puerto );
        ...
        try {
            ...
            /**
            if(!login){
                int dialogButton = JOptionPane.showConfirmDialog (null, "Desea Reenviar", "Error ",JOptionPane.YES_NO_OPTION);

                if(dialogButton == JOptionPane.YES_OPTION) {
                    
                this.Enviar(name, file, protocolo, puerto);
            ...
            System.out.println("Custom Exception: " + ex.getMessage());
                  JOptionPane.showMessageDialog(null, "Custom Exception: " + ex);
                  int dialogButton = JOptionPane.showConfirmDialog (null, "Desea Reenviar", "Error ",JOptionPane.YES_NO_OPTION);
  ...
  if(file.exists()){
   ...
   e.printStackTrace();
            ...
            System.out.println("Custom Exception: " + ex.getMessage());
                ...
                this.uploadFileToFTP( file,debug);}
        }
 }
